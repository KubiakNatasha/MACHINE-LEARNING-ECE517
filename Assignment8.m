...
scatter(x,y,'blue','o');
hold on
plot(xs,ys,'mo','LineWidth',2);
plot(xs,s_plus1,'black--',xs,ys,'m--',xs,s_minus1,'black--','LineWidth',2);
plot(xs,s_plus2,'black--',xs,s_minus2,'black--');
title('One-dimensional Regression');
legend('','', '1\sigma Band','' ,'', '2\sigma Band','Location', 'northeast');